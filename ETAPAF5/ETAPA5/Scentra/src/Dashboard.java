...
public class Dashboard extends JFrame implements ActionListener {
    ...
    public void tab() {
        String[] columnNames = {"Fecha", "Acción", "Detalle"}; 
        ...
        Object[][] historialData = {
            {"2025-06-26 10:30", "Salida de Producto", "ID: P001, Cant: 5"},
            {"2025-06-25 15:45", "Entrada de Producto", "ID: P002, Cant: 10"}
        };

        for (Object[] row : historialData) {
            model.addRow(row);
        }
    }
...
// Clases simuladas (mantengo estas para que el código sea ejecutable)
class SesionUsuario {
...
class Inventarios extends JFrame {
    public Inventarios() {
        setTitle("Inventarios");
        setSize(400, 300);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setLocationRelativeTo(null);
        JLabel label = new JLabel("Ventana de Inventarios");
...
class Historial extends JFrame {
    public Historial() {
        ...
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setLocationRelativeTo(null);
        JLabel label = new JLabel("Ventana de Historial");
        label.setHorizontalAlignment(SwingConstants.CENTER);
        add(label);
        setVisible(true);
    }
...
class Configuracion extends JFrame {
    public Configuracion() {
        setTitle("Configuración");
        setSize(400, 300);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setLocationRelativeTo(null);
        JLabel label = new JLabel("Ventana de Configuración");
        label.setHorizontalAlignment(SwingConstants.CENTER);
        add(label);
        setVisible(true);
    }
...
class Empleados extends JFrame {
    public Empleados() {
        ...
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setLocationRelativeTo(null);
        JLabel label = new JLabel("Ventana de Empleados");
        label.setHorizontalAlignment(SwingConstants.CENTER);
        add(label);
        setVisible(true);
    }
...
class Inicio_de_sesion extends JFrame {
    public Inicio_de_sesion() {
        setTitle("Inicio de Sesión");
        setSize(400, 300);
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLocationRelativeTo(null);
        JLabel label = new JLabel("Ventana de Inicio de Sesión");
        label.setHorizontalAlignment(SwingConstants.CENTER);
        add(label);
        setVisible(true);
    }
