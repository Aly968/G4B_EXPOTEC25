...
//        pnlTextos.setBounds(40, 150, 350, 225);
    ...
    public void MostrarProductos() {
        ...
        try {
            MostrarProductos.mostrarProductos(this.idEmpresaUsuario, mdTabla); // Se llama al método del DAO
            JOptionPane.showMessageDialog(this, "Datos de Productos Terminados actualizados correctamente.", "Actualización Exitosa", JOptionPane.INFORMATION_MESSAGE);
