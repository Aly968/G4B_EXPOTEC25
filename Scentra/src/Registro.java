...
//Gabriel Ricardo Rodriguez de León
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //Si se presiona el boton iniciar 
        if (e.getSource() == iniciar) {
            ...
            //Verifica que los campos no esten en blanco antes de ingresar
            ...
            //Establece variables que ayudan en la verificacion de datos
            Connection conn = null;
            PreparedStatement stmt = null;
            ResultSet rs = null;
            //try que maneja los errores al ejecutar insercción de datos
            try {
                //Crea un objeto de clase conexion y abre esa misma
                Conexion con = new Conexion();
                conn = con.getConnection();
                //Permite el guardar temporalmente los datos hasta confirmar definitivamente la insercción al unirse a  una empresa
                conn.setAutoCommit(false);

                //Genera un nuevo Id empezando desde 1000
                int crearId = 1000;
                ...
                if (rs.next()) {
                    ...
                    // Insertar el nuevo usuario con ID generado manualmente
                    ...
                    //Si el numero de filas es mayor a 0(deberia ser 1 si se inserto el registro)
                    if (rowsAffected > 0) {

                        JOptionPane.showMessageDialog(this, "Paso 1 Completado");
                        //Abre ventana de registro a empresa y cierra actual
                ...
                //Si algo falla en el proceso manda mensaje de error
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this, "Error al registrar usuario: " + ex.getMessage());
                //Si falla cierra conexion a BD
                if (conn != null) {
                    try {
                        conn.close();
                ...
                //Cierra ResultSet y cierra Stantement
