...
VALUES
    ...
    (6, 'Materias Primas del Sol',       'Proveedores', 'Naranja',       'MPS', 'logo_mpsol.png',    'EMP-006'),
    (7, 'Creaciones Artesanales',        'Fabricación', 'Turquesa',      'CAR', 'logo_car.png',      'EMP-007'),
    (8, 'Distribuidora Fénix',           'Distribución','Rojo',          'DFX', 'logo_dfx.png',      'EMP-008'),
    (9, 'Soluciones de Empaque',         'Empaque',     'Gris',          'SDE', 'logo_sde.png',      'EMP-009'),
    (10, 'Insumos Industriales S.A.',    'Proveedores', 'Azul Marino',   'IIS', 'logo_iis.png',      'EMP-010'),
    (11, 'Velas del Alba',              'Fabricación', 'Celeste',       'VDA', 'logo_vda.png',    'EMP-011'),
    (12, 'Esencias Naturales',          'Proveedores', 'Marrón',        'ESN', 'logo_esn.png',      'EMP-012'),
    (13, 'Embalajes Seguros',           'Empaque',     'Nego',          'EMB', 'logo_emb.png',      'EMP-013'),
    (14, 'Fabricantes Premium',         'Fabricación', 'Dorado',        'FPR', 'logo_fpr.png',      'EMP-014'),
    (15, 'Mayoristas Globales',         'Distribución','Plata',         'MGL', 'logo_mgl.png',      'EMP-015'),
    (16, 'Proveedores Top',             'Proveedores', 'Morado',        'PTO', 'logo_pto.png',      'EMP-016'),
    (17, 'Artículos Aromáticos',        'Fabricación', 'Rosa',          'AAR', 'logo_aar.png',      'EMP-017'),
    (18, 'Logística Express',           'Distribución','Magenta',       'LEX', 'logo_lex.png',      'EMP-018'),
    (19, 'Suministros Ecológicos',      'Empaque',     'Lima',          'SEC', 'logo_sec.png',      'EMP-019'),
    (20, 'Comercializadora Central',    'Fabricación', 'Blanco',        'CEN', 'logo_cen.png',      'EMP-020');
