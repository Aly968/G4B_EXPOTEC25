...
//    JComboBox CmbTipoIndustria;
    ...
    private void finalizarRegistro() {
        ...
        try {
            ...
            stmt.executeUpdate();
            // Actualizar el usuario con el nuevo idEmpresa y estado
            ...
            // En caso de error, intenta hacer rollback de la transacción
            if (conn != null) {
                try {
                    conn.rollback();
                } catch (SQLException ex2) {
                    ex2.printStackTrace(); // Imprime error si el rollback falla
                }
            }
            ...
            try {
                ...
                ex.printStackTrace(); // Imprime error al cerrar recursos
            }
        }
    }
}
