...
public class Update_Empleados extends JFrame implements ActionListener {
    ...
    public void initComponents() {
        ...
        JScrollPane scroll = new JScrollPane(tablaMaterial);
        ...
        tablaMaterial.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                ...
                if (fila >= 0) {
                    txtFabricacion.setText((String) tablaMaterial.getValueAt(fila, 1));
                    txtIngreso.setText((String) tablaMaterial.getValueAt(fila, 2));
                    txtEmpleado.setText((String) tablaMaterial.getValueAt(fila, 3));
                    txtCantidad.setText((String) tablaMaterial.getValueAt(fila, 4));
                    txtSerie.setText((String) tablaMaterial.getValueAt(fila, 5));
                }
            }
        });
    }
